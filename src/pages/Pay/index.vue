    ...
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="payshipInfo">
          ...
          <div class="step-cont">
            <ul class="payType">
              <li><img src="/images/payAbout/pay10.jpg"></li>
              <li><img src="/images/payAbout/pay11.jpg"></li>
              <li><img src="/images/payAbout/pay12.jpg"></li>
              <li><img src="/images/payAbout/pay13.jpg"></li>
              <li><img src="/images/payAbout/pay14.jpg"></li>
              <li><img src="/images/payAbout/pay15.jpg"></li>
              <li><img src="/images/payAbout/pay16.jpg"></li>
              <li><img src="/images/payAbout/pay17.jpg"></li>
              <li><img src="/images/payAbout/pay18.jpg"></li>
              <li><img src="/images/payAbout/pay19.jpg"></li>
              <li><img src="/images/payAbout/pay20.jpg"></li>
              <li><img src="/images/payAbout/pay21.jpg"></li>
              <li><img src="/images/payAbout/pay22.jpg"></li>
      ...
      .checkout-tit {
        ...
        .tit-txt {
          ...
          .success-icon {
            ...
            background: url(/images/payAbout/icon.png) no-repeat 0 0;
          }
